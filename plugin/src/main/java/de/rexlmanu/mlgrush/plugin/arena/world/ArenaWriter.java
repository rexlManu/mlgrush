    ...
    Bukkit.getScheduler()
        .runTask(
            ...
            () -> {
                  ...
                  for (int z = 0; z < layout[x][y].length; z++) {
                    ...
                    Location location =
                        new Location(
                            ...
                            startPoint.getZ() + z);
                    ingredients.stream()
                        .filter(ingredient -> ingredient.code() == code)
                        .findAny()
                        .ifPresent(
                            ingredient -> {
                              ...
                              try {
                                block.setBlockData(
                                    Bukkit.createBlockData(ingredient.material()), false);
                              } catch (IllegalArgumentException ignored) {
                                block.setType(
                                    Material.valueOf(ingredient.material().toUpperCase()), false);
                              }
                            });
                  }
                }
              ...
              System.out.println(
                  String.format("Map generated in %sms.", System.currentTimeMillis() - start));
            });
  }
}

...
public interface CommandParameter {
  ...
  static void require(String name, int position, String[] arguments)
      throws CommandParameterMissingException {
    if (arguments.length < (position + 1))
      throw new CommandParameterMissingException(
          String.format("Der Parameter &8'&a%s&8' &7fehlt.", name));
  }

  static <T> T cast(String name, int position, String[] arguments, Class<T> type)
      throws CommandParameterMissingException {
    ...
    try {
      ...
      throw new CommandParameterMissingException(
          String.format(
              "Der Parameter &8'&a%s&8' &7muss Type &8'&a%s&8' &7sein.", name, type.getName()));
    }
  }
}
